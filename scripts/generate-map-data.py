...
def main():
    ...
    sprints = [
        ...
        {"id": "sprint14", "name": "Sprint 14 — Validation & Finalisation des 14 Pages Connectées", "status": "in_progress", "startedAt": "2026-03-09",
         "tasks": [
             {"name": "Valider /admin/workflows/[id] — détail workflow avec éditeur", "status": "todo", "page": "/admin/workflows/[id]"},
             {"name": "Valider /admin/animaux/[id] — fiche animal complète", "status": "todo", "page": "/admin/animaux/[id]"},
             {"name": "Valider /admin/documents — gestion documentaire", "status": "todo", "page": "/admin/documents"},
             {"name": "Valider /admin/animaux/couvees/[id] — détail couvée", "status": "todo", "page": "/admin/animaux/couvees/[id]"},
             {"name": "Valider /admin/cites — registre CITES", "status": "todo", "page": "/admin/cites"},
             {"name": "Valider /admin/medical/calendrier — calendrier vétérinaire", "status": "todo", "page": "/admin/medical/calendrier"},
             {"name": "Valider /admin — tableau de bord principal", "status": "todo", "page": "/admin"},
             {"name": "Valider /admin/security — gestion sécurité", "status": "todo", "page": "/admin/security"},
             {"name": "Valider /admin/swagger — documentation API", "status": "todo", "page": "/admin/swagger"},
             {"name": "Valider /admin/api-v2 — API publique v2", "status": "todo", "page": "/admin/api-v2"},
             {"name": "Valider /admin/websocket — monitoring temps réel", "status": "todo", "page": "/admin/websocket"},
             {"name": "Valider /admin/formation/cohortes — gestion cohortes", "status": "todo", "page": "/admin/formation/cohortes"},
             {"name": "Valider /admin/formation/mon-parcours/[enrollmentId] — suivi apprenant", "status": "todo", "page": "/admin/formation/mon-parcours/[enrollmentId]"},
             {"name": "Valider /admin/ventes/[id] — détail vente", "status": "todo", "page": "/admin/ventes/[id]"},
             {"name": "Finaliser module export (dette technique 70%)", "status": "todo", "page": None},
         ]},
    ]
