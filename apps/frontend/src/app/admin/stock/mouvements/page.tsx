    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground max-w-md">
          Cette fonctionnalité est en cours de développement. Elle permettra de suivre les entrées et sorties de stock, les transferts entre zones et l&apos;historique complet des mouvements.
        </p>
      </div>
