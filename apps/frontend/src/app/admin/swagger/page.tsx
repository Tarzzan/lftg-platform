    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white dark:bg-card rounded-xl border border-gray-200 dark:border-border shadow-sm p-4">
        ...
        <input
          ...
          placeholder="Rechercher un endpoint ou une description..."className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"/>
      </div>
                  ...
                  <div className="px-4 pb-4 bg-gray-50 dark:bg-muted/20 border-t border-gray-100">
                    <div className="mt-3 space-y-2">
                      ...
                      <div className="flex gap-4 text-sm">
                        ...
                        <span className={endpoint.auth ?'text-yellow-700 font-medium':'text-green-700 font-medium'}>{endpoint.auth ?' Bearer JWT requis':' Accès public'}</span>
                      </div>
                      <div className="mt-3">
                        <a
